...
const openPaymentApp = (
  ...
  if (type === 'venmo') {
    const deepLink = `venmo://paycharge?txn=pay&recipients=${username}&amount=${amount}&note=${encodeURIComponent(
      note
    )}`;
...
const PredictionApp = () => {
  ...
  const handleJoinPrediction = (side: string, amount: number) => {
    ...
    const updated = {
      ...selectedPrediction,
      commitments: [
        ...selectedPrediction.commitments,
        {
  ...
  const calculatePoolStats = (commitments: any[]) => {
    const sideA = commitments
      .filter((c) => c.side === 'a')
      .reduce((sum, c) => sum + c.amount, 0);
    const sideB = commitments
      .filter((c) => c.side === 'b')
      .reduce((sum, c) => sum + c.amount, 0);
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-cyan-300/60 text-sm tracking-wide">
            Private predictions • Zero fees • Pure competition
          </p>
        </div>
        ...
        {groups.length === 0 ? (
          <div className="backdrop-blur-xl bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/20 rounded-3xl p-12 text-center mt-8">
            ...
            <p className="text-gray-600 text-sm">
              Create your first group to start making predictions
            </p>
          </div>
        ) : (
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="sticky top-0 bg-black/95 backdrop-blur-xl border-b border-purple-500/20 px-4 py-4">
        <button
          onClick={onBack}
          className="text-purple-400 font-bold flex items-center gap-2 hover:text-purple-300 transition-colors"
        >
      ...
      <div className="max-w-md mx-auto p-6">
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-purple-300 font-bold mb-3 text-sm uppercase tracking-wide">
              Group Name
            </label>
            <input
              type="text"
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="sticky top-0 bg-gradient-to-b from-black via-black/95 to-transparent backdrop-blur-xl border-b border-purple-500/20 px-4 py-6 z-10">
        <button
          onClick={onBack}
          className="text-purple-400 font-bold mb-4 flex items-center gap-2 hover:text-purple-300 transition-colors"
        >
          <ArrowRight className="w-5 h-5 rotate-180" />
          Back
        </button>
            ...
            {predictions.map((pred: any) => {
              ...
              return (
                <div
                  ...
                  className="backdrop-blur-xl bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-purple-500/20 p-6 rounded-3xl hover:border-purple-500/40 active:scale-98 transition-all cursor-pointer"
                >
      ...
      <div className="max-w-md mx-auto p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-cyan-300 font-bold mb-3 text-sm uppercase tracking-wide">
                Side B
              </label>
              <input
                type="text"
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-5 top-5 text-gray-500 text-xl">
                $
              </span>
              <input
                type="number"
...
const SettlementView = ({ prediction, onBack }: any) => {
  ...
  const handlePayment = (type: string, user: any, amount: number) => {
    ...
    openPaymentApp(
      type,
      user.venmoUsername || user.cashAppTag,
      amount,
      `${prediction.title} settlement`
    );
  };
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    {loser.venmoUsername && (
                      <button
                        onClick={() =>
                          handlePayment('venmo', loser, loser.loss)
                        }
                    ...
                    {loser.cashAppTag && (
                      <button
                        onClick={() =>
                          handlePayment('cashapp', loser, loser.loss)
                        }
